...
def run_evaluation_test():
    ...
    try:
        ...
        if test_type not in ["lease_summary", "risk_flags", "key_terms", "key_terms_local", "key_terms_simple", "key_terms_llamacloud", "key_terms_llamaextract", "asset_type_classification"]:
